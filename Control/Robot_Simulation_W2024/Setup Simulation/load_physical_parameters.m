function robot = load_physical_parameters()
    ...
    robot.num_magnets = 5; % [MEASURE] how many magnets are attached to the wheel (equally spaced)
    ...
    robot.time_between_piston_fires_min = 0.6; % (seconds) the shortest allowable time between successive fires    
